  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: Obx(
          ()=> profileController.isGettingProfile.value ? const Center(child: CircularProgressIndicator.adaptive(),) :
          Column(
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(children: [
                    Obx(
                      ()=> profileController.isUploadingImage.value ? const Center(child: CircularProgressIndicator.adaptive(),):
                       Stack(
                        alignment: Alignment.bottomRight,
                        children: [
                         (profileController.userProfileModel.value.data!= null && profileController.userProfileModel.value.data?.profilePicture!=null) ?  CircleAvatar(
                            radius: 72,
                      
                            backgroundImage: 
                            
                            NetworkImage("${ApiPath.imageUrl}${profileController.userProfileModel.value.data?.profilePicture}" )
