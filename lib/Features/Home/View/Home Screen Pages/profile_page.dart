        ...
        child: Column(
          ...
          children: [
            ...
            ProfileCard(
              ...
              trailing: InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (newContext) =>const PersonalDetailsScreen(),),);
                },
                child: const Icon(
            ...
            ProfileCard(
              ...
              trailing: InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (newContext) =>const PrivacyScreen(),),);
                },
                child: const Icon(
                  Icons.arrow_forward_ios,
                  size: 12,
